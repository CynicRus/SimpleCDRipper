...
const
  ...
  { TWThread }
   type
    ...
    protected
      ...
      procedure ShowProgress(IncTrackProgress,IncOverallProgress: integer; msg: string = '');
  ...
  begin
    ...
    procedure TWThread.ShowProgress(IncTrackProgress,
    IncOverallProgress: integer; msg: string);
  begin
    ...
    msg := msg + #32 + FormatFloat('0.00 %',RoundTo(TrackProgress * 100.0 / TrackProgressMax, -2));
